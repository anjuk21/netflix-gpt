    ...
    const handleButtonClick=()=>{
       ...
       const message= checkValidData(email.current.value,password.current.value );
        ...
        if(!isSignInForm){
           ...
           updateProfile(user, {
            displayName: name.current.value, photoURL: "https://media.naukri.com/media/jphotov1/l244%253ALukcMTq83QcYHLi0UQgEbpwyxXkkb8kzg1t73K8ibpu%252FbyY%252F94vdNf9tD%252BpN?v=20250427171059"
           }).then(() => {
          // Profile updated!
            // ...
